...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("dev.adrianlorenzo.crmservice.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                new Contact(properties.getName(), properties.getWebpage(), properties.getEmail()),
